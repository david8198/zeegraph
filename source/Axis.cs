...
namespace ZeeGraph
{
	...
	#region Class Fields
		...
		/// <summary>
		/// private field that stores the <see cref="ZeeGraph.Scale" /> class, which implements all the
		...
		/// Use the public properties <see cref="Cross"/> and <see cref="ZeeGraph.Scale.BaseTic"/>
	...
	#region Scale Properties
		...
		/// <seealso cref="ZeeGraph.Scale.Min"/>
		/// <seealso cref="ZeeGraph.Scale.Max"/>
		/// <seealso cref="ZeeGraph.Scale.MajorStep"/>
	...
	#region Tic Properties
		...
		/// <summary>
		/// Gets a reference to the <see cref="ZeeGraph.MajorTic" /> class instance
		...
		/// <summary>
		/// Gets a reference to the <see cref="ZeeGraph.MinorTic" /> class instance
	...
	#region Type Properties
		...
		/// <seealso cref="ZeeGraph.Scale.IsVisible"/>.
		...
		/// </remarks>
		/// <seealso cref="ZeeGraph.Scale.IsLog"/>
		/// <seealso cref="ZeeGraph.Scale.IsText"/>
		/// <seealso cref="ZeeGraph.Scale.IsOrdinal"/>
		/// <seealso cref="ZeeGraph.Scale.IsDate"/>
		/// <seealso cref="ZeeGraph.Scale.IsReverse"/>
	...
	#region Rendering Methods
		...
		/// </param>
		/// <seealso cref="ZeeGraph.Scale.MinAuto"/>
		/// <seealso cref="ZeeGraph.Scale.MaxAuto"/>
		/// <seealso cref="ZeeGraph.Scale.MajorStepAuto"/>
		/// <seealso cref="ZeeGraph.Scale.MagAuto"/>
		/// <seealso cref="ZeeGraph.Scale.FormatAuto"/>
...
//		abstract internal float GetMinPix( GraphPane pane );
		...
		/// <see cref="Cross" />, <see cref="CrossAuto" />, and <see cref="ZeeGraph.Scale.IsReverse" />.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <remarks>
		/// This method properly accounts for <see cref="ZeeGraph.Scale.IsLog"/>,
		/// <see cref="ZeeGraph.Scale.IsText"/>,
		...
		/// (<see cref="ZeeGraph.Scale.IsLog"/>)
		/// and text (<see cref="ZeeGraph.Scale.IsText"/>) type axes.
		/// </param>
