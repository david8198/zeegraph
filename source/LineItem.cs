...
namespace ZeeGraph
{
	...
	#region Fields
		...
		/// <summary>
		/// Private field that stores a reference to the <see cref="ZeeGraph.Symbol"/>
		/// class defined for this <see cref="LineItem"/>.  Use the public
		/// property <see cref="Symbol"/> to access this value.
		/// </summary>
		protected Symbol	_symbol;
		/// <summary>
		/// Private field that stores a reference to the <see cref="ZeeGraph.Line"/>
		/// class defined for this <see cref="LineItem"/>.  Use the public
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see cref="ZeeGraph.Symbol"/> class instance defined
		...
		/// <summary>
		/// Gets or sets the <see cref="ZeeGraph.Line"/> class instance defined
		/// for this <see cref="LineItem"/>.
		/// </summary>
		public Line Line
		{
