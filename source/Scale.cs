...
*/
		...
		/// <summary>
		/// Gets a reference to the <see cref="ZeeGraph.FontSpec"/> class used to render
		/// the scale values
		/// </summary>
...
*/
		...
		/// true to get the bounding box of the text using the <see cref="ZeeGraph.FontSpec.Angle" />,
