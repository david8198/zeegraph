...
{
	// <summary>
	// <c>ZedGraph</c> is a class library and UserControl (<see cref="ZeeGraphControl"/>) that display
	...
	#region Private Fields
		...
		/// <summary>Private field instance of the <see cref="ZeeGraph.XAxis"/> class.  Use the
		...
		/// <summary>Private field instance of the <see cref="ZeeGraph.YAxisList"/> class.  Use the
		/// public property <see cref="GraphPane.YAxisList"/> to access this class.</summary>
		private YAxisList _yAxisList;
		/// <summary>Private field instance of the <see cref="ZeeGraph.Y2AxisList"/> class.  Use the
		/// public property <see cref="GraphPane.Y2AxisList"/> to access this class.</summary>
		private Y2AxisList _y2AxisList;
		/// <summary>Private field instance of the <see cref="ZeeGraph.CurveList"/> class.  Use the
		...
		/// zooming and panning functionality for the <see cref="ZeeGraphControl"/>.
		/// </summary>
		...
		/// graphs will be displayed. See the <see cref="ZeeGraph.LineType"/> enum
	...
	#region Defaults
		...
		public new struct Default
		{
			...
			/// <see cref="ZeeGraph.LineType"/> for more information.
			/// </summary>
	...
	#region Rendering Methods
		...
		/// <summary>
		/// Calculate the <see cref="ZeeGraph.Chart.Rect"/> based on the <see cref="PaneBase.Rect"/>.
		/// </summary>
...
//			minSpaceT = Math.Max( minSpaceT, spaceT );
	...
	#region General Utility Methods
		...
		/// </summary>
		/// <remarks>This method implicitly assumes that <see cref="ZeeGraph.Chart.Rect"/>
		/// has already been calculated via <see cref="AxisChange()"/> or
		/// <see cref="Draw"/> methods, or the <see cref="ZeeGraph.Chart.Rect"/> is
		/// set manually (see <see cref="ZeeGraph.Chart.IsRectAuto"/>).</remarks>
		...
		/// has already been calculated via <see cref="AxisChange()"/> or
		/// <see cref="Draw"/> methods, or the <see cref="ZeeGraph.Chart.Rect"/> is
		/// set manually (see <see cref="ZeeGraph.Chart.IsRectAuto"/>).
