...
namespace ZeeGraph
{
    ...
    public abstract class PaneBase : ICloneable
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="ZeeGraph.Border"/> class for drawing the border
        ...
        /// <summary>
        /// Gets or sets the <see cref="ZeeGraph.Fill"/> data for the
        ...
        /// <summary>
        /// Gets or sets the <see cref="ZeeGraph.Margin" /> instance that controls the space between
        ...
        /// <summary>
        /// Raised when the Rect Property has changed
        /// </summary>
        ...
        /// To do so, you must separately call <see cref="ZeeGraph.Legend.CalcRect"/>.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the
        /// PaintEventArgs argument to the Paint() method.
...
/*
		...
		*/
        ...
        /// <summary>
        /// Raises the RectChanged Event
        /// </summary>
        protected virtual void OnRectChanged(EventArgs e)
        {
            if (RectChanged == null) return;

            foreach (EventHandler handler in RectChanged.GetInvocationList())
            {
                try
                {
                    handler(this, e);
