...
namespace ZeeGraph
{
	...
	public class ZeeGraphException : System.ApplicationException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ZeeGraphException"/>
		...
		protected ZeeGraphException( System.Runtime.Serialization.SerializationInfo info,
		...
		public ZeeGraphException( System.String message, System.Exception innerException )
		...
		/// </summary>
		/// <param name="message">The error message that explains the reason for the exception.</param>
		public ZeeGraphException ( System.String message )
			: base( message )
		{
		}
