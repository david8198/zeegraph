...
namespace ZeeGraph
{
    partial class ZeeGraphControl
    {
        ...
        /// </summary>
        /// <param name="sender">The source <see cref="ZeeGraphControl"/> object</param>
        ...
        public delegate void ContextMenuBuilderEventHandler(ZeeGraphControl sender,
        ...
        /// want the <see cref="ZeeGraphControl"/> to do any further action.
        /// Return false if ZedGraph should go ahead and process the LinkEvent.
        /// </returns>
        public delegate bool LinkEventHandler(ZeeGraphControl sender, GraphPane pane,
        ...
        public delegate string PointEditHandler(ZeeGraphControl sender, GraphPane pane,
        ...
        /// <seealso cref="PointValueEvent" />
        public delegate string PointValueHandler(ZeeGraphControl sender, GraphPane pane,
                                                 CurveItem curve, int iPt);
        ...
        public delegate void ScrollDoneHandler(ZeeGraphControl sender, ScrollBar scrollBar,
        ...
        /// <see cref="GraphPane"/> after the scroll event</param>
        /// <seealso cref="ZoomEvent" />
        public delegate void ScrollProgressHandler(ZeeGraphControl sender, ScrollBar scrollBar,
                                                   ZoomState oldState, ZoomState newState);
        ...
        /// want the <see cref="ZeeGraphControl"/> to do any further action (e.g., starting
        /// a zoom operation).  Return false if ZedGraph should go ahead and process the
        /// mouse event.
        /// </returns>
        public delegate bool ZedMouseEventHandler(ZeeGraphControl sender, MouseEventArgs e);
        ...
        /// <seealso cref="ZoomEvent" />
        public delegate void ZoomEventHandler(ZeeGraphControl sender, ZoomState oldState,
                                              ZoomState newState);
        ...
        /// with this <see cref="ZeeGraphControl" />.  This event will use the
        /// <see cref="ZeeGraph.MasterPane.FindNearestPaneObject"/> method to determine which object
        /// was clicked.  The boolean value that you return from this handler determines whether
        /// or not the <see cref="ZeeGraphControl"/> will do any further handling of the
        ...
        /// <summary>
        /// Hide the standard control MouseDown event so that the ZeeGraphControl.MouseDownEvent
        ...
        /// <summary>
        /// Hide the standard control MouseUp event so that the ZeeGraphControl.MouseUpEvent
        /// can be used.  This is so that the user must return true/false in order to indicate
        /// whether or not we should respond to the event.
        /// </summary>
        [Bindable(false), Browsable(false)]
        ...
        /// new ZeeGraphControl.PointEditHandler( MyPointEditHandler );</code>
        ...
        /// new ZeeGraphControl.PointValueHandler( MyPointValueHandler );</code>
        /// <para>Add this method to your Form1.cs:</para>
        /// <code>
        ...
        /// <summary>
        /// Hide the standard control MouseMove event so that the ZeeGraphControl.MouseMoveEvent
        /// can be used.  This is so that the user must return true/false in order to indicate
        /// whether or not we should respond to the event.
        /// </summary>
        [Bindable(false), Browsable(false)]
        ...
        private void HandleZoomFinish(object sender, MouseEventArgs e)
        {
            ...
            if (_isEnableVZoom && !zoomLimitExceeded)
            {
                for (int i = 0; i < y1.Length; i++)
                {
                    if (Math.Abs(y1[i] - y2[i]) >= ZoomResolution) continue;
                ...
                for (int i = 0; i < yy1.Length; i++)
                {
                    if (Math.Abs(yy1[i] - yy2[i]) >= ZoomResolution) continue;
