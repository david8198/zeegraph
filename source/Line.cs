...
namespace ZeeGraph
{
	...
	#region Fields
		...
		/// <summary>
		/// Private field that stores the <see cref="ZeeGraph.StepType"/> for this
		/// <see cref="CurveItem"/>.  Use the public
		/// property <see cref="StepType"/> to access this value.
		/// </summary>
		private StepType _stepType;
		/// <summary>
		/// Private field that stores the <see cref="ZeeGraph.Fill"/> data for this
	...
	#region Properties
		...
		/// </summary>
		/// <value><see cref="ZeeGraph.StepType"/> enum value</value>
	...
	#region Rendering Methods
		...
		/// would not see coordinates like this, if you repeatedly zoom in on a ZeeGraphControl, eventually
