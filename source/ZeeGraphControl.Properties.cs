...
namespace ZeeGraph
{
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see cref="ZeeGraph.MasterPane"/> property for the control
		/// </summary>
		...
		*/
		...
		/// <summary>
		/// Gets or sets the <see cref="ZeeGraph.GraphPane"/> property for the control
		/// </summary>
		/// <remarks>
		/// <see cref="ZeeGraphControl"/> actually uses a <see cref="MasterPane"/> object
		...
		/// <see cref="ZeeGraphControl"/>.  It provides options for Zoom, Pan, AutoScale, Clipboard
		...
		/// <see cref="ZeeGraph.GraphPane.IsBoundedRanges" /> before activating this option.</b>
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// in the <see cref="MasterPane" /> associated with this <see cref="ZeeGraphControl" />
		...
		/// in the <see cref="ZeeGraph.GraphPane.YAxisList" />.  Each ordinal location in
		/// <see cref="YScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see cref="ZeeGraph.GraphPane.YAxisList" />.
		/// </remarks>
		...
		/// <remarks>
		/// This list maintains the user scale ranges for the scroll bars for each axis
		/// in the <see cref="ZeeGraph.GraphPane.Y2AxisList" />.  Each ordinal location in
		/// <see cref="Y2ScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see cref="ZeeGraph.GraphPane.Y2AxisList" />.
		/// </remarks>
		/// <seealso cref="ScrollMinY2" />
		/// <seealso cref="ScrollMaxY2" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true )]
		...
		/// <seealso cref="Bitmap"/>
		/// </summary>
		/// <exception cref="ZeeGraphException">
		...
		/// same as <c>ZeeGraphControl.GraphPane == null</c>.
		/// </summary>
		[Bindable( false ), Browsable( false ),
		 DesignerSerializationVisibility( DesignerSerializationVisibility.Hidden )]
