...
namespace ZeeGraph
{
	...
	#region Properties
		/// <summary>
		/// The <see cref="ZeeGraph.Location"/> struct that describes the location
		...
		/// the same <see cref="ZeeGraph.ZOrder"/> value is controlled by their order in
		/// the <see cref="GraphObjList"/>.  The first <see cref="GraphObj"/>
		/// in the list is drawn in front of other <see cref="GraphObj"/>
		/// objects having the same <see cref="ZeeGraph.ZOrder"/> value.</remarks>
	...
	#region Constructors
		...
		/// <see cref="ZeeGraph.Location.CoordinateFrame"/> property.  The text will be
		...
		/// <see cref="ZeeGraph.Location.CoordinateFrame"/> property.
		/// </remarks>
