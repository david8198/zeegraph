...
namespace ZeeGraph.Web
{
	#region ZeeGraphWebCurveItem
	/// <summary>
	...
	public abstract class ZeeGraphWebCurveItem : GenericItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebCurveItem()
			: base()
		{
			Register( '0', typeof( ZeeGraphWebPointPairCollection ) );
		}
		...
		public ZeeGraphWebCurveItem( string label )
			: base()
		{
			Label = label;
		}
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebCurveItem"/> to the specified
		...
		/// bound to this <see cref="CurveItem"/>.
		/// </summary>
		...
		/// </summary>
		/// <remarks> A text string that represents the <see cref="Legend"/>
		...
		/// <see cref="Fill.Color"/> properties for this curve
		/// </remarks>
		...
		/// <seealso cref="ZeeGraph.Label.IsVisible">Label.IsVisible</seealso>
		[Category( "Curve Details" ), NotifyParentProperty( true ),
		...
		public ZeeGraphWebPointPairCollection Points
		{
			get { return (ZeeGraphWebPointPairCollection)GetValue( '0' ); }
		}
	...
	#region ZeeGraphWebBorder

	/// <summary>
	/// Web control state management class for a <see cref="Border"/> object.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebBorder : GenericItem
	{
		/// <summary>
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebBorder"/> to the specified
		/// <see cref="Border"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Border"/> object</param>
	...
	/// <summary>
	/// Todo: idem ZeeGraphWebFill2
	/// </summary>
	public class ZeeGraphWebBorder2 : ZeeGraphWebBorder
	{
		/// <summary>
		/// Default constructor
		/// </summary>
		public ZeeGraphWebBorder2()
			: base()
		{
			this.IsVisible = true;
		}
	...
	#region ZeeGraphWebFill
	/// <summary>
	/// Web control state management class for a <see cref="Fill"/> object.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebFill : GenericItem
	{
		/// <summary>
		/// Override ToString() function
		/// </summary>
		...
		public override string ToString()
		{
			...
			if ( this.Type != FillType.None )
				text += " (" + this.Color.Name + ")";
			return text;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebFill"/> to the specified
		/// <see cref="Fill"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Fill"/> object</param>
		...
		/// <seealso cref="Fill.IsGradientValueType"/>
	...
	/// </summary>
	public class ZeeGraphWebFill2 : ZeeGraphWebFill
	{
		/// <summary>
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebFill2()
		{
	...
	#region ZeeGraphWebSymbol
	/// <summary>
	/// Web control state management class for a <see cref="Symbol"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebSymbol : GenericItem
	{
		/// <summary>
		/// Override ToString() function
		/// </summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebSymbol()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );

			this.Fill.Color = Symbol.Default.FillColor;
			this.Fill.Brush = Symbol.Default.FillBrush;
			this.Fill.Type = Symbol.Default.FillType;

			this.Border.IsVisible = Symbol.Default.IsBorderVisible;
			this.Border.Color = Symbol.Default.BorderColor;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebSymbol"/> to the specified
		...
		#region Border
		/// <summary>
		/// Proxy property that gets or sets the <see cref="ZeeGraphWebBorder"/> object for
		/// this <see cref="Symbol"/>.
		/// </summary>
		/// <seealso cref="ZeeGraph.Border"/>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		NotifyParentProperty( true ),
		...
		public ZeeGraphWebBorder Border
		{
			get { return (ZeeGraphWebBorder)base.GetValue( 'b' ); }
		}
		#endregion
		...
		/// <summary>
		/// Proxy property that gets or sets the <see cref="ZeeGraphWebFill"/> object for
		/// this <see cref="Symbol"/>.
		/// </summary>
		/// <seealso cref="ZeeGraph.Fill"/>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		NotifyParentProperty( true ),
		...
		public ZeeGraphWebFill Fill
		{
			get { return (ZeeGraphWebFill)base.GetValue( 'f' ); }
		}
	...
	#region ZeeGraphWebBarItem
	/// <summary>
	/// Web control state management class for a <see cref="BarItem"/> class
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebBarItem : ZeeGraphWebCurveItem
	{
		/// <summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebBarItem()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );

			this.Border.Width = Bar.Default.BorderWidth;
			this.Border.Color = Bar.Default.BorderColor;
			this.Fill.Color = Bar.Default.FillColor;
			this.Fill.Type = Bar.Default.FillType;
			this.Fill.Brush = Bar.Default.FillBrush;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebBarItem"/> to the specified
		/// <see cref="BarItem"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="BarItem"/> object</param>
	...
	#region ZeeGraphWebErrorBarItem
	/// <summary>
	/// Web control state management class for a <see cref="ErrorBarItem"/> class
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebErrorBarItem : ZeeGraphWebCurveItem
	{
		/// <summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebErrorBarItem()
			: base()
		{
			Register( 's', typeof( ZeeGraphWebSymbol ) );

			this.Symbol.SymbolType = ErrorBar.Default.Type;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebErrorBarItem"/> to the specified
		/// <see cref="ErrorBarItem"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="ErrorBarItem"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the <see cref="ZeeGraphWebSymbol"/> object for
		/// this <see cref="ErrorBarItem"/>.
		/// </summary>
		/// <seealso cref="ZeeGraph.Symbol"/>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		NotifyParentProperty( true ),
		...
		public ZeeGraphWebSymbol Symbol
		{
			get { return (ZeeGraphWebSymbol)base.GetValue( 's' ); }
		}
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ErrorBar.PenWidth"/>.
		/// </summary>
	...
	#region ZeeGraphWebHiLowBarItem
	/// <summary>
	/// Web control state management class for a <see cref="HiLowBarItem"/> class
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebHiLowBarItem : ZeeGraphWebCurveItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebHiLowBarItem()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebHiLowBarItem"/> to the specified
		/// <see cref="HiLowBarItem"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="HiLowBarItem"/> object</param>
	...
	#region ZeeGraphWebLineItem
	/// <summary>
	/// Web control state management class for a <see cref="LineItem"/> class
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebLineItem : ZeeGraphWebCurveItem
	{
		/// <summary>
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebLineItem"/> to the specified
		/// <see cref="LineItem"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="LineItem"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Line.IsSmooth"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Line.SmoothTension"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="LineBase.Style"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Line.StepType"/>.
		/// </summary>
		...
		/// be forward oriented <c>ForwardStep</c> (<see cref="ZeeGraph.StepType"/>) or
		...
		public ZeeGraphWebSymbol Symbol
		{
			get { return (ZeeGraphWebSymbol)GetValue( 's' ); }
		}
		#endregion
		...
		public ZeeGraphWebFill Fill
		{
			get { return (ZeeGraphWebFill)GetValue( 'f' ); }
		}
		#endregion
	}
	#endregion

	#region ZeeGraphWebPieItem
	/// <summary>
	/// Web control state management class for a <see cref="PieItem"/> class
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebPieItem : ZeeGraphWebCurveItem
	{
		/// <summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebPieItem()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 't', typeof( ZeeGraphWebTextObj ) );

			this.Border.IsVisible = PieItem.Default.IsBorderVisible;
			this.Border.Width = PieItem.Default.BorderWidth;
			this.Border.Color = PieItem.Default.BorderColor;
			this.LabelDetail.FontSpec.Size = PieItem.Default.FontSize;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebPieItem"/> to the specified
		/// <see cref="PieItem"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="PieItem"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.Value"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.Displacement"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.LabelType"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.ValueDecimalDigits"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.PercentDecimalDigits"/>.
		/// </summary>
		/// <remarks> Gets or sets the number of decimal digits to be displayed in a <see cref="PieItem"/>
		/// percent label.
		/// </remarks>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="PieItem.LabelDetail"/>.
		/// </summary>
		...
		public ZeeGraphWebTextObj LabelDetail
		{
			get { return (ZeeGraphWebTextObj)base.GetValue( 't' ); }
		}
	...
	#region ZeeGraphWebGraphObj

	/// <summary>
	/// Baseclass for graph items in the web control
	/// <seealso cref="GraphObj"/>
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebGraphObj : GenericItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebGraphObj()
			: base()
		{
			Register( 'l', typeof( ZeeGraphWebLocation ) );
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebGraphObj"/> to the specified
		/// <see cref="GraphObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="GraphObj"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="GraphObj.IsVisible"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="GraphObj.Location"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebLocation Location
		{
			get { return (ZeeGraphWebLocation)base.GetValue( 'l' ); }
		}

		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="GraphObj.ZOrder"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
	...
	#region ZeeGraphWebCurveCollection
	/// <summary>
	/// Manages a collection of <see cref="ZeeGraphWebCurveItem"/> objects that are
	/// state management aware.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebCurveCollection : GenericCollection
	{
		/// <summary>
		/// Override the ToString() method.
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebCurveCollection()
			: base()
		{
			Schema = new GenericCollectionItemSchema[5];
			Schema[0].code = 'b';
			Schema[0].type = typeof( ZeeGraphWebBarItem );
			Schema[1].code = 'l';
			Schema[1].type = typeof( ZeeGraphWebLineItem );
			Schema[2].code = 'e';
			Schema[2].type = typeof( ZeeGraphWebErrorBarItem );
			Schema[3].code = 'h';
			Schema[3].type = typeof( ZeeGraphWebHiLowBarItem );
			Schema[4].code = 'p';
			Schema[4].type = typeof( ZeeGraphWebPieItem );
		}

		/// <summary>
		/// Add a <see cref="ZeeGraphWebCurveItem"/> to this collection.
		/// </summary>
		/// <param name="item">The <see cref="ZeeGraphWebCurveItem"/> to be added.</param>
		/// <seealso cref="CurveItem"/>
		public void Add( ZeeGraphWebCurveItem item )
		{
			if ( null != item )
				ListAdd( item );
			else
		...
		/// <summary>
		/// Indexer to access the specified <see cref="ZeeGraphWebCurveItem"/> object by
		/// its ordinal position in the list.
		/// </summary>
		/// <param name="index">The ordinal position (zero-based) of the
		/// <see cref="ZeeGraphWebCurveItem"/> object to be accessed.</param>
		/// <value>A <see cref="ZeeGraphWebCurveItem"/> object reference.</value>
		/// <seealso cref="CurveItem"/>
		[
		NotifyParentProperty( true ),
		...
		{
			get { return (ZeeGraphWebCurveItem)ListGet( index ); }
	...
	#region ZeeGraphWebGraphObjCollection
	/// <summary>
	/// Manages a collection of <see cref="ZeeGraphWebGraphObj"/> objects that are
	/// state management aware.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebGraphObjCollection : GenericCollection
	{
		/// <summary>
		/// Override the ToString() method.
		/// </summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebGraphObjCollection()
			: base()
		{
			Schema = new GenericCollectionItemSchema[5];
			Schema[0].code = 't';
			Schema[0].type = typeof( ZeeGraphWebTextObj );
			Schema[1].code = 'a';
			Schema[1].type = typeof( ZeeGraphWebArrowObj );
			Schema[2].code = 'i';
			Schema[2].type = typeof( ZeeGraphWebImageObj );
			Schema[3].code = 'b';
			Schema[3].type = typeof( ZeeGraphWebBoxObj );
			Schema[4].code = 'e';
			Schema[4].type = typeof( ZeeGraphWebEllipseObj );
		}

		/// <summary>
		/// Add a <see cref="ZeeGraphWebGraphObj"/> to this collection.
		/// </summary>
		/// <param name="item">The <see cref="ZeeGraphWebGraphObj"/> to be added.</param>
		/// <seealso cref="GraphObj"/>
		public void Add( ZeeGraphWebGraphObj item )
		{
			if ( null != item )
				ListAdd( item );
			else
		...
		/// <summary>
		/// Indexer to access the specified <see cref="ZeeGraphWebGraphObj"/> object by
		/// its ordinal position in the list.
		/// </summary>
		/// <param name="index">The ordinal position (zero-based) of the
		/// <see cref="ZeeGraphWebGraphObj"/> object to be accessed.</param>
		/// <value>A <see cref="ZeeGraphWebGraphObj"/> object reference.</value>
		/// <seealso cref="GraphObj"/>
		[
		NotifyParentProperty( true ),
		Description( "Indexer for accessing the GraphObjs in this collection" )
		]
		public ZeeGraphWebGraphObj this[int index]
		{
			get { return (ZeeGraphWebGraphObj)ListGet( index ); }
			set { ListInsert( index, value ); }
		}
	}
	...
	#region ZeeGraphWebStringCollection
	/// <summary>
	/// Manages a collection of <see cref="ZeeGraphWebGraphObj"/> objects that are
	/// state management aware.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebStringCollection : GenericCollection
	{
		/// <summary>
		/// Override the ToString() method.
		/// </summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebStringCollection()
			: base()
		{
			Schema = new GenericCollectionItemSchema[1];
			Schema[0].code = 's';
			Schema[0].type = typeof( ZeeGraphWebString );
		}

		/// <summary>
		/// Add a <see cref="ZeeGraphWebString"/> to the collection.
		/// </summary>
		/// <param name="item">The <see cref="ZeeGraphWebString"/> object to be added</param>
		public void Add( ZeeGraphWebString item )
		{
			if ( null != item )
				ListAdd( item );
		}
		...
		public ZeeGraphWebString this[int index]
		{
			get { return (ZeeGraphWebString)ListGet( index ); }
			set { ListInsert( index, value ); }
		}
	}
	...
	#region ZeeGraphWebPointPairCollection
	/// <summary>
	/// Manages a collection of <see cref="ZeeGraphWebPointPair"/> objects that are
	/// state management aware.
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebPointPairCollection : GenericCollection
	{
		/// <summary>
		/// Override the ToString() method.
		/// </summary>
		...
		/// Default Constructor
		/// </summary>
		public ZeeGraphWebPointPairCollection()
			: base()
		{
			Schema = new GenericCollectionItemSchema[1];
			Schema[0].code = 'p';
			Schema[0].type = typeof( ZeeGraphWebPointPair );
		}

		/// <summary>
		/// Add a <see cref="ZeeGraphWebPointPair"/> to this collection.
		/// </summary>
		/// <param name="item">The <see cref="ZeeGraphWebPointPair"/> to be added.</param>
		/// <seealso cref="PointPair"/>
		public void Add( ZeeGraphWebPointPair item )
		{
			if ( null != item )
				ListAdd( item );
			else
		...
		/// <summary>
		/// Indexer to access the specified <see cref="ZeeGraphWebPointPair"/> object by
		/// its ordinal position in the list.
		/// </summary>
		/// <param name="index">The ordinal position (zero-based) of the
		/// <see cref="ZeeGraphWebPointPair"/> object to be accessed.</param>
		/// <value>A <see cref="ZeeGraphWebPointPair"/> object reference.</value>
		/// <seealso cref="PointPair"/>
		[
		NotifyParentProperty( true ),
		Description( "Indexer for accessing the PointPair objects in this collection" )
		]
		public ZeeGraphWebPointPair this[int index]
		{
			get { return (ZeeGraphWebPointPair)ListGet( index ); }
			set { ListInsert( index, value ); }
		}
	}
	...
	#region ZeeGraphWebPointPair
	/// <summary>
	/// A Web PointPair class
	/// </summary>
	/// <author>Darren Martz</author>
	[DefaultProperty( "Value" )]
	public class ZeeGraphWebPointPair : GenericItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebPointPair()
			: base()
		{
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebPointPair"/> to the specified
	...
	#region ZeeGraphWebString
	/// <summary>
	/// A Web String class
	/// </summary>
	/// <author>Darren Martz</author>
	[DefaultProperty( "Value" )]
	public class ZeeGraphWebString : GenericItem
	{
		/// <summary>
	...
	#region ZeeGraphWebGrid

	/// <summary>
	/// Proxy class to manage all properties associated with a grid
	/// </summary>
	public class ZeeGraphWebGrid : GenericItem
	{
		/// <summary>
		...
		public override string ToString()
		{
			return "ZeeGraphWebGrid";
		}

		/// <summary>
		/// Default constructor
		/// </summary>
		public ZeeGraphWebGrid()
			: base()
		{
		}
		/*
	...
	*/
		...
		#region properties
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.Color"/>.
		/// </summary>
		[
		Category("Appearance"),
		NotifyParentProperty(true),
		...
		public Color Color
		{
			...
			{
				object x = ViewState["Color"];
				return (null == x) ? MajorGrid.Default.Color : (Color)x;
			}
			set { ViewState["Color"] = value; }
		}
		...
		public bool IsVisible
		{
			...
			{
				object x = ViewState["IsVisible"];
				return (null == x) ? MajorGrid.Default.IsVisible : (bool)x;
			}
			set { ViewState["IsVisible"] = value; }
		}
		...
		public float DashOn
		{
			get
			{
				...
				return (null == x) ? MajorGrid.Default.DashOn : (float)x;
			}
		...
		public float DashOff
		{
			get
			{
				...
				return (null == x) ? MajorGrid.Default.DashOff : (float)x;
			}
		...
		public float PenWidth
		{
			...
			{
				object x = ViewState["PenWidth"];
				return (null == x) ? MajorGrid.Default.PenWidth : (float)x;
			}
			set { ViewState["PenWidth"] = value; }
		}
		#endregion
	...
	#region ZeeGraphWebTic

	/// <summary>
	/// Proxy class to manage all properties associated with a grid
	/// </summary>
	public class ZeeGraphWebTic : GenericItem
	{
		/// <summary>
		/// Returns a string description of the class
		/// </summary>
		public override string ToString()
		{
			return "ZeeGraphWebTic";
		}

		/// <summary>
		/// Default constructor
		/// </summary>
		public ZeeGraphWebTic()
			: base()
		{
		}
/*
...
*/
		...
		public Color Color
		{
			...
			{
				object x = ViewState["Color"];
				return (null == x) ? MajorTic.Default.Color : (Color)x;
			}
			set { ViewState["Color"] = value; }
		}
		...
		/// </summary>
		/// <remarks> The length of the <see cref="Axis"/> tic marks, expressed in points
		/// (1/72nd inch).
		/// </remarks>
		[
		Category("Appearance"),
		...
		public float Size
		{
			...
			{
				object x = ViewState["Size"];
				return (null == x) ? MajorTic.Default.Size : (float)x;
			}
			set { ViewState["Size"] = value; }
		}
		...
		/// </summary>
		/// <remarks> Determines whether or not the <see cref="Axis"/> major tics (where the
		...
		public bool IsOutside
		{
			get
			{
				...
				return (null == x) ? MajorTic.Default.IsOutside : (bool)x;
			}
		...
		public bool IsInside
		{
			get
			{
				...
				return (null == x) ? MajorTic.Default.IsInside : (bool)x;
			}
		...
		public bool IsOpposite
		{
			get
			{
				...
				return (null == x) ? MajorTic.Default.IsOpposite : (bool)x;
			}
		...
		/// this <see cref="Axis"/>.  The pen width is expressed in points (1/72nd inch).
		/// </remarks>
		[
		Category("Appearance"),
		NotifyParentProperty(true),
		...
		public float PenWidth
		{
			...
			{
				object x = ViewState["PenWidth"];
				return (null == x) ? MajorTic.Default.PenWidth : (float)x;
			}
			set { ViewState["PenWidth"] = value; }
		}
	...
	#region ZeeGraphWebScale

	/// <summary>
	/// Proxy class to manage all properties associated with a grid
	/// </summary>
	public class ZeeGraphWebScale : GenericItem
	{
		/// <summary>
		/// Returns a string description of the class
		/// </summary>
		public override string ToString()
		{
			return "ZeeGraphWebScale";
		}

		/// <summary>
		/// Default constructor
		/// </summary>
		public ZeeGraphWebScale()
			: base()
		{
			Register( 'z', typeof( ZeeGraphWebFontSpec ) );

			this.MinorUnit = DateUnit.Day;
			this.MajorUnit = DateUnit.Day;
			this.FontSpec.Family = Scale.Default.FontFamily;
			this.FontSpec.Size = Scale.Default.FontSize;
			this.FontSpec.IsBold = Scale.Default.FontBold;
			this.FontSpec.FontColor = Scale.Default.FontColor;
			this.FontSpec.IsItalic = Scale.Default.FontItalic;
			this.FontSpec.IsUnderline = Scale.Default.FontUnderline;
			this.FontSpec.Fill.Color = Scale.Default.FillColor;
			this.FontSpec.Fill.Type = Scale.Default.FillType;
			this.FontSpec.Border.IsVisible = false;

		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebScale"/> to the specified
		/// <see cref="Scale"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Scale"/> object</param>
		...
		public double MinGrace
		{
			get
			{
				...
				return (null == x) ? Scale.Default.MinGrace : (double)x;
			}
		...
		public double MaxGrace
		{
			get
			{
				...
				return (null == x) ? Scale.Default.MaxGrace : (double)x;
			}
		...
		/// </summary>
		/// <remarks> Determines if the scale values are reversed for this <see cref="Axis"/>.
		/// </remarks>
		[
		Category( "Behavior" ),
		NotifyParentProperty(true),
		...
		public bool IsReverse
		{
			get
			{
				...
				return ( null == x ) ? Scale.Default.IsReverse : (bool)x;
			}
		...
		/// </summary>
		/// <remarks> The format of the <see cref="Axis"/> tic labels.
		...
		public string Format
		{
			get
			{
				...
				return (null == x) ? Scale.Default.Format : (string)x;
			}
		...
		/// </summary>
		/// <remarks> Controls the alignment of the <see cref="Axis"/> tic labels.
		/// </remarks>
		[NotifyParentProperty(true)]
		...
		public AlignP Align
		{
			get
			{
				...
				return (null == x) ? Scale.Default.Align : (AlignP)x;
			}
		...
		/// </summary>
		/// <remarks> Gets a reference to the <see cref="ZeeGraph.FontSpec"/> class used to render
		/// the scale values.
		/// </remarks>
		[
		Category("Appearance"),
		...
		public ZeeGraphWebFontSpec FontSpec
		{
			get { return (ZeeGraphWebFontSpec)base.GetValue('z'); }
		}
	...
	public class ZeeGraphWebAxis : GenericItem
	{
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebAxis()
			: base()
		{
			Register( 'Z', typeof( ZeeGraphWebFontSpec ) );
			Register( 'y', typeof( ZeeGraphWebGrid ) );
			Register( 'Y', typeof( ZeeGraphWebGrid ) );
			Register( 't', typeof( ZeeGraphWebTic ) );
			Register( 'T', typeof( ZeeGraphWebTic ) );
			Register( 's', typeof( ZeeGraphWebScale ) );

			//this.MajorGrid.SetDefaultsForMajorGrid();
			//this.MinorGrid.SetDefaultsForMinorGrid();

			this.FontSpec.Family = Axis.Default.TitleFontFamily;
			this.FontSpec.Size = Axis.Default.TitleFontSize;
			this.FontSpec.IsBold = Axis.Default.TitleFontBold;
			this.FontSpec.FontColor = Axis.Default.TitleFontColor;
			this.FontSpec.IsItalic = Axis.Default.TitleFontItalic;
			this.FontSpec.IsUnderline = Axis.Default.TitleFontUnderline;
			this.FontSpec.Fill.Color = Axis.Default.TitleFillColor;
			this.FontSpec.Fill.Type = Axis.Default.TitleFillType;
			this.FontSpec.Border.IsVisible = false;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebAxis"/> to the specified
		/// <see cref="Axis"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Axis"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.Cross"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.CrossAuto"/>.
		/// </summary>
		/// <remarks> Determines whether or not the axis intersection point <see cref="Axis.Cross"/>
		/// is set automatically.
		/// </remarks>
		[
		Category( "Behavior" ),
		...
		public Color AxisColor
		{
			get
			{
				...
				return ( null == x ) ? Axis.Default.Color : (Color)x;
			}
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.MinSpace"/>.
		/// </summary>
		...
		public float MinSpace
		{
			get
			{
				...
				return ( null == x ) ? Axis.Default.MinSpace : (float)x;
			}
			set { ViewState["MinSpace"] = value; }
		}

		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ZeeGraph.MajorTic.IsBetweenLabels"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ZeeGraph.MajorGrid.IsZeroLine"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.IsVisible"/>.
		/// </summary>
		/// <remarks> Determines whether or not the <see cref="Axis"/> is shown.
		/// </remarks>
		[
		Category( "Appearance" ),
		NotifyParentProperty(true),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Axis.Type"/>.
		/// </summary>
		/// <remarks> Determines the <see cref="AxisType"/> for this <see cref="Axis"/>.
		...
		public AxisType Type
		{
			...
			{
				object x = ViewState["Type"];
				return ( null == x ) ? Axis.Default.Type : (AxisType)x;
			}
			set { ViewState["Type"] = value; }
		}
		...
		/// </summary>
		/// <remarks> Determines whether or not the <see cref="Axis"/>
		/// <see cref="Axis.Title"/> will be displayed.
		/// </remarks>
		[
		Category( "Appearance" ),
		NotifyParentProperty(true),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ZeeGraph.Scale.IsUseTenPower"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ZeeGraph.Scale.IsPreventLabelOverlap"/>.
		/// </summary>
		...
		public ZeeGraphWebGrid MinorGrid
		{
			get { return (ZeeGraphWebGrid)base.GetValue( 'y' ); }
		}
		...
		public ZeeGraphWebGrid MajorGrid
		{
			get { return (ZeeGraphWebGrid)base.GetValue( 'Y' ); }
		}
		...
		public ZeeGraphWebTic MinorTic
		{
			get { return (ZeeGraphWebTic)base.GetValue( 't' ); }
		}
		...
		public ZeeGraphWebTic MajorTic
		{
			get { return (ZeeGraphWebTic)base.GetValue( 'T' ); }
		}
		...
		public ZeeGraphWebScale Scale
		{
			get { return (ZeeGraphWebScale)base.GetValue( 's' ); }
		}
	...
	#region ZeeGraphWebLegend
	/// <summary>
	/// Web control state management class for a <see cref="Legend"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebLegend : GenericItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebLegend()
			: base()
		{
			//Register( 'r', typeof( ZeeGraphWebRect ) );
			Register( 'F', typeof( ZeeGraphWebFontSpec ) );
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );
			Register( 'l', typeof( ZeeGraphWebLocation ) );
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebLegend"/> to the specified
		/// <see cref="Legend"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Legend"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets the value of <see cref="Legend.Location"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		/// <summary>
		/// Proxy property that gets the value of <see cref="Legend.FontSpec"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebFontSpec FontSpec
		{
			get { return (ZeeGraphWebFontSpec)base.GetValue( 'F' ); }
		}

		/// <summary>
		/// Proxy property that gets the value of <see cref="Legend.Fill"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		/// <summary>
		/// Proxy property that gets the value of <see cref="Legend.Border"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebRect Rect
		{
			get { return (ZeeGraphWebRect)base.GetValue( 'r' ); }
		}
		*/
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Legend.IsVisible"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Legend.IsHStack"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Legend.Position"/>.
		/// </summary>
		...
		// CJBL
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Legend.IsReverse"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
	...
	#region ZeeGraphWebFontSpec
	/// <summary>
	/// Web control state management class for a <see cref="FontSpec"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebFontSpec : GenericItem
	{
		/// <summary>
		/// Identifies fontspec instance
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebFontSpec()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );

			this.Fill.Color = FontSpec.Default.FillColor;
			this.Fill.Brush = FontSpec.Default.FillBrush;
			this.Fill.Type = FontSpec.Default.FillType;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebFontSpec"/> to the specified
		/// <see cref="FontSpec"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="FontSpec"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.Angle"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.Size"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.Family"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.FontColor"/>.
		/// </summary>
		...
		/// <see cref="ZeeGraph.Fill.Color"/> properties, respectively.
		/// </remarks>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.StringAlignment"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.IsBold"/>.
		/// </summary>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.IsItalic"/>.
		/// </summary>
		/// <remarks> Determines whether this <see cref="FontSpec"/> is
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="FontSpec.IsUnderline"/>.
		/// </summary>
		/// <remarks> Determines whether this <see cref="FontSpec"/> is
		...
		public ZeeGraphWebBorder Border
		{
			get { return (ZeeGraphWebBorder)GetValue( 'b' ); }
		}
	...
	#region ZeeGraphWebRect (Left, Top, Right, Bottom)
	/// <summary>
	/// Rectangle class for margins
	/// </summary>
	/// <author>Benjamin Mayrargue</author>
	public class ZeeGraphWebRect : GenericItem
	{
		/// <summary>
		/// Override ToString
		/// </summary>
	...
	#region ZeeGraphWebSize
	/// <summary>
	/// Size class for a <see cref="FontSpec"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebSize : GenericItem
	{
		/// <summary>
		/// Identifies fontspec instance
		/// </summary>
	...
	#region ZeeGraphWebPointD
	/// <summary>
	/// Point class for a <see cref="FontSpec"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebPointD : GenericItem
	{
		/// <summary>
		/// Identifies fontspec instance
		/// </summary>
	...
	///			.layoutArea
	/// </remarks>
	public class ZeeGraphWebTextObj : ZeeGraphWebGraphObj
	{
		/// <summary>
		/// Identifies curve item by the labels value
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebTextObj()
			: base()
		{
			Register( 'a', typeof( ZeeGraphWebSize ) );
			Register( 'f', typeof( ZeeGraphWebFontSpec ) );

			this.FontSpec.Family = TextObj.Default.FontFamily;
			this.FontSpec.Size = TextObj.Default.FontSize;
			this.FontSpec.FontColor = TextObj.Default.FontColor;
			this.FontSpec.IsBold = TextObj.Default.FontBold;
			this.FontSpec.IsUnderline = TextObj.Default.FontUnderline;
			this.FontSpec.IsItalic = TextObj.Default.FontItalic;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebTextObj"/> to the specified
		/// <see cref="TextObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="TextObj"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="TextObj.Text"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets the value of <see cref="TextObj.LayoutArea"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebSize LayoutArea
		{
			get { return (ZeeGraphWebSize)GetValue( 'a' ); }
		}

		/// <summary>
		/// Proxy property that gets the value of <see cref="TextObj.FontSpec"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebFontSpec FontSpec
		{
			get { return (ZeeGraphWebFontSpec)GetValue( 'f' ); }
		}
	}
	#endregion

	#region ZeeGraphWebArrowObj
	/// <summary>
	/// Baseclass for graph items in the web control
	/// <seealso cref="GraphObj"/>
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebArrowObj : ZeeGraphWebGraphObj
	{
		/// <summary>
		/// Identifies curve item by the labels value
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebArrowObj()
			: base()
		{
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebArrowObj"/> to the specified
		/// <see cref="ArrowObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="ArrowObj"/> object</param>
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ArrowObj.Size"/>.
		/// </summary>
		...
		/// Proxy property that gets or sets the value of <see cref="LineBase.Color"/>.
		/// </summary>
		/// <remarks> The <see cref="System.Drawing.Color"/> value used to draw the <see cref="ArrowObj"/>.
		/// </remarks>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ArrowObj.IsArrowHead"/>.
		/// </summary>
	...
	#region ZeeGraphWebImageObj
	/// <summary>
	/// Baseclass for graph items in the web control
	/// <seealso cref="GraphObj"/>
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebImageObj : ZeeGraphWebGraphObj
	{
		/// <summary>
		/// Identifies curve item by the labels value
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebImageObj()
			: base()
		{
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebImageObj"/> to the specified
		/// <see cref="ImageObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="ImageObj"/> object</param>
		...
		/// data for this <see cref="ImageObj"/>.
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="ImageObj.IsScaled"/>.
		/// </summary>
		/// <remarks>
	...
	#region ZeeGraphWebBoxObj
	/// <summary>
	/// Baseclass for graph items in the web control
	/// <seealso cref="GraphObj"/>
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebBoxObj : ZeeGraphWebGraphObj
	{
		/// <summary>
		/// Identifies curve item by the labels value
		/// </summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebBoxObj()
			: base()
		{
			Register( 'b', typeof( ZeeGraphWebBorder ) );
			Register( 'f', typeof( ZeeGraphWebFill ) );

			this.Border.Color = BoxObj.Default.BorderColor;
			this.Fill.Color = BoxObj.Default.FillColor;
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebBoxObj"/> to the specified
		/// <see cref="BoxObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="BoxObj"/> object</param>
	...
	#region ZeeGraphWebEllipseObj
	/// <summary>
	/// Baseclass for graph items in the web control
	/// <seealso cref="GraphObj"/>
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebEllipseObj : ZeeGraphWebGraphObj
	{
		/// <summary>
		/// Identifies curve item by the labels value
		/// </summary>
		...
		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebEllipseObj"/> to the specified
		/// <see cref="EllipseObj"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="EllipseObj"/> object</param>
	...
	#region ZeeGraphWebLocation
	/// <summary>
	/// Location class for a <see cref="FontSpec"/> object
	/// </summary>
	/// <author>Darren Martz</author>
	public class ZeeGraphWebLocation : GenericItem
	{
		/// <summary>
		...
		/// Default constructor
		/// </summary>
		public ZeeGraphWebLocation()
			: base()
		{
			//Register( 'r', typeof( ZeeGraphWebRect ) );
			Register( 't', typeof( ZeeGraphWebPointD ) );
			Register( 'b', typeof( ZeeGraphWebPointD ) );
		}

		/// <summary>
		/// Copy the properties of this <see cref="ZeeGraphWebLocation"/> to the specified
		/// <see cref="Location"/> object.
		/// </summary>
		/// <param name="item">The destination <see cref="Location"/> object</param>
		...
		public ZeeGraphWebRect Rect
		{
			get { return (ZeeGraphWebRect)GetValue( 'r' ); }
		}
		*/
		/// <summary>
		/// Proxy property that gets the value of <see cref="Location.TopLeft"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebPointD TopLeft
		{
			get { return (ZeeGraphWebPointD)GetValue( 't' ); }
		}

		/// <summary>
		/// Proxy property that gets the value of <see cref="Location.BottomRight"/>
		/// </summary>
		[
		Category( "Appearance" ),
		DesignerSerializationVisibility( DesignerSerializationVisibility.Content ),
		...
		public ZeeGraphWebPointD BottomRight
		{
			get { return (ZeeGraphWebPointD)GetValue( 'b' ); }
		}

		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.Height"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.Width"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.Y"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.X"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.AlignH"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.AlignV"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
		...
		/// <summary>
		/// Proxy property that gets or sets the value of <see cref="Location.CoordinateFrame"/>
		/// </summary>
		[
		NotifyParentProperty( true ),
